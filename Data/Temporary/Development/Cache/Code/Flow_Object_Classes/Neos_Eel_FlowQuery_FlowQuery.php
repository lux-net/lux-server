 ...
 */
class FlowQuery_Original implements ProtectedContextAwareInterface, \IteratorAggregate, \Countable
{
    /**
 ...
 * If an operation is final, it should return the resulting value directly.
 */
class FlowQuery extends FlowQuery_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Eel\FlowQuery\FlowQuery' === get_class($this)) {
  ...
  'operationResolver' => 'Neos\\Eel\\FlowQuery\\OperationResolverInterface',
    ...
    {
        $this->setOperationResolver(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Eel\FlowQuery\OperationResolverInterface'));
        $this->Flow_Injected_Properties = array (
  0 => 'operationResolver',
);
    }
}
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Eel/Classes/FlowQuery/FlowQuery.php
#