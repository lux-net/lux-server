 ...
 */
class NumbersReader extends NumbersReader_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Cldr\Reader\NumbersReader') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Cldr\Reader\NumbersReader', $this);
        if ('Neos\Flow\I18n\Cldr\Reader\NumbersReader' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\I18n\Cldr\Reader\NumbersReader';
        if ($isSameClass) {
  ...
  'localizedSymbols' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Cldr\Reader\NumbersReader', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
    ...
    {
        $this->injectCache(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Flow_I18n_Cldr_Reader_NumbersReaderCache'));
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/Reader/NumbersReader.php
#