...
class StandardController extends StandardController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('AgzHack\LightMarkerImporter\Controller\StandardController' === get_class($this)) {
  ...
  'supportedMediaTypes' => 'array',
    ...
    {
        $this->injectSettings(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'AgzHack.LightMarkerImporter'));
...
# PathAndFilename: /var/www/lux/Packages/Application/AgzHack.LightMarkerImporter/Classes/Controller/StandardController.php
#