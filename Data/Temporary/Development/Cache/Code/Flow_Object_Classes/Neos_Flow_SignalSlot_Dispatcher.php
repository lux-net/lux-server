...
class Dispatcher extends Dispatcher_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\SignalSlot\Dispatcher') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\SignalSlot\Dispatcher', $this);
        if ('Neos\Flow\SignalSlot\Dispatcher' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/SignalSlot/Dispatcher.php
#