...
latex_documents = [
  (master_doc, 'AgzHack.Lux.tex', u'AgzHack.Lux Documentation',
   u'The author', 'manual'),
]
...
man_pages = [
    (master_doc, 'AgzHack.Lux', u'AgzHack.Lux Documentation',
     [author], 1)
]
