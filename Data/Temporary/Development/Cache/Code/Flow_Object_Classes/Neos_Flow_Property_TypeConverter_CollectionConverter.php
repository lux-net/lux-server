 ...
 */
class CollectionConverter_Original extends AbstractTypeConverter
{
    /**
     * @var array<string>
     */
 ...
 */
class CollectionConverter extends CollectionConverter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Property\TypeConverter\CollectionConverter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Property\TypeConverter\CollectionConverter', $this);
    }
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Property/TypeConverter/CollectionConverter.php
#