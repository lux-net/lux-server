 ...
 */
class FlowAnnotationDriver_Original implements DoctrineMappingDriverInterface, PointcutFilterInterface
{
    /**
     * @var integer
     */
 ...
 */
class FlowAnnotationDriver extends FlowAnnotationDriver_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        if (get_class($this) === 'Neos\Flow\Persistence\Doctrine\Mapping\Driver\FlowAnnotationDriver') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Persistence\Doctrine\Mapping\Driver\FlowAnnotationDriver', $this);
        parent::__construct();
        if ('Neos\Flow\Persistence\Doctrine\Mapping\Driver\FlowAnnotationDriver' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Persistence/Doctrine/Mapping/Driver/FlowAnnotationDriver.php
#