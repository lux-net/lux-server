 ...
 */
class PluralsReader extends PluralsReader_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Cldr\Reader\PluralsReader') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Cldr\Reader\PluralsReader', $this);
        if ('Neos\Flow\I18n\Cldr\Reader\PluralsReader' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\I18n\Cldr\Reader\PluralsReader';
        if ($isSameClass) {
  ...
  'rulesetsIndices' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Cldr\Reader\PluralsReader', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
    ...
    {
        $this->injectCache(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Flow_I18n_Cldr_Reader_PluralsReaderCache'));
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/Reader/PluralsReader.php
#