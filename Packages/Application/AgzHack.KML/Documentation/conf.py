...
latex_documents = [
  (master_doc, 'AgzHack.KML.tex', u'AgzHack.KML Documentation',
   u'The author', 'manual'),
]
...
man_pages = [
    (master_doc, 'AgzHack.KML', u'AgzHack.KML Documentation',
     [author], 1)
]
