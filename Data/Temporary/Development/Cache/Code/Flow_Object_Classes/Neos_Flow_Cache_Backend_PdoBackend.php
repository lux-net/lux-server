 ...
 */
class PdoBackend_Original extends \Neos\Cache\Backend\PdoBackend implements FlowSpecificBackendInterface
{
 ...
 * 
 */
class PdoBackend extends PdoBackend_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Flow\Cache\Backend\PdoBackend' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\Cache\Backend\PdoBackend';
        if ($isSameClass) {
  ...
  'environment' => 'Environment',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Cache\Backend\PdoBackend', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Cache/Backend/PdoBackend.php
#