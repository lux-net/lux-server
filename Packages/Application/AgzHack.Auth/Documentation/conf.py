...
htmlhelp_basename = 'AgzHack.Auth'
...
latex_documents = [
  (master_doc, 'AgzHack.Auth.tex', u'AgzHack.Auth Documentation',
   u'The author', 'manual'),
]
...
man_pages = [
    (master_doc, 'AgzHack.Auth', u'AgzHack.Auth Documentation',
     [author], 1)
]
