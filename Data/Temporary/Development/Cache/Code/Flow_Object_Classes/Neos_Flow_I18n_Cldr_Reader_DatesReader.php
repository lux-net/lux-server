 ...
 */
class DatesReader extends DatesReader_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Cldr\Reader\DatesReader') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Cldr\Reader\DatesReader', $this);
        if ('Neos\Flow\I18n\Cldr\Reader\DatesReader' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\I18n\Cldr\Reader\DatesReader';
        if ($isSameClass) {
  ...
  'maxLengthOfSubformats' => 'array',
  'parsedFormats' => 'array',
  'parsedFormatsIndices' => 'array',
  'localizedLiterals' => 'array',
);
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Cldr\Reader\DatesReader', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
    ...
    {
        $this->injectCache(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Flow_I18n_Cldr_Reader_DatesReaderCache'));
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/Reader/DatesReader.php
#