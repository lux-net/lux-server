 ...
 * @api
 */
class NumberFormatter_Original implements FormatterInterface
{
    /**
     * @var NumbersReader
     */
 ...
 */
class NumberFormatter extends NumberFormatter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Formatter\NumberFormatter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Formatter\NumberFormatter', $this);
        if ('Neos\Flow\I18n\Formatter\NumberFormatter' === get_class($this)) {
  ...
  'numbersReader' => 'Neos\\Flow\\I18n\\Cldr\\Reader\\NumbersReader',
    ...
    {
        $this->injectNumbersReader(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\I18n\Cldr\Reader\NumbersReader'));
        $this->Flow_Injected_Properties = array (
  0 => 'numbersReader',
);
    }
}
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Formatter/NumberFormatter.php
#