 ...
 * @api
 */
class TextfieldViewHelper_Original extends AbstractFormFieldViewHelper
{
    /**
     * @var string
     */
 ...
 * </output>
 */
class TextfieldViewHelper extends TextfieldViewHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        parent::__construct();
        if ('Neos\FluidAdaptor\ViewHelpers\Form\TextfieldViewHelper' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.FluidAdaptor/Classes/ViewHelpers/Form/TextfieldViewHelper.php
#