 ...
 * Implementation of a standard route
 */
class Route extends Route_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Flow\Mvc\Routing\Route' === get_class($this)) {
  ...
  'uriPattern' => 'string',
  'lowerCase' => 'boolean',
  'appendExceedingArguments' => 'boolean',
  'matchResults' => 'array',
  'matchedTags' => 'RouteTags|null',
  'resolvedUriConstraints' => 'UriConstraints|null',
  'resolvedTags' => 'RouteTags|null',
  'routePartsConfiguration' => 'array',
  'routeParts' => 'array',
  'httpMethods' => 'array non-associative array e.g. array(\'GET\', \'POST\')',
  'isParsed' => 'boolean',
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Mvc/Routing/Route.php
#