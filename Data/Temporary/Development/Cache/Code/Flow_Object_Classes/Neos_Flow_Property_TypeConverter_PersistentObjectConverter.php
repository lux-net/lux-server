 ...
 */
class PersistentObjectConverter extends PersistentObjectConverter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Property\TypeConverter\PersistentObjectConverter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Property\TypeConverter\PersistentObjectConverter', $this);
        if ('Neos\Flow\Property\TypeConverter\PersistentObjectConverter' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Property/TypeConverter/PersistentObjectConverter.php
#