 ...
 */
class MvcPropertyMappingConfigurationService extends MvcPropertyMappingConfigurationService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Mvc\Controller\MvcPropertyMappingConfigurationService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Mvc\Controller\MvcPropertyMappingConfigurationService', $this);
        if ('Neos\Flow\Mvc\Controller\MvcPropertyMappingConfigurationService' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Mvc/Controller/MvcPropertyMappingConfigurationService.php
#