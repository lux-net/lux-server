...
class UsersController_Original extends RestController
{
...
class UsersController extends UsersController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('AgzHack\Api\Controller\UsersController' === get_class($this)) {
    ...
    public function loginAction($token)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['loginAction'])) {
            $result = parent::loginAction($token);
            ...
            try {
                ...
                $adviceChain->rewind();
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'AgzHack\Api\Controller\UsersController', 'loginAction', $methodArguments, $adviceChain);
...
# PathAndFilename: /var/www/lux/Packages/Application/AgzHack.Api/Classes/Controller/UsersController.php
#