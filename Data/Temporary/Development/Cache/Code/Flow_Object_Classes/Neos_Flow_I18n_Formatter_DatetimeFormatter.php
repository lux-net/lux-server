 ...
 * @api
 */
class DatetimeFormatter_Original implements FormatterInterface
{
    /**
     * @var DatesReader
     */
 ...
 */
class DatetimeFormatter extends DatetimeFormatter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Formatter\DatetimeFormatter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Formatter\DatetimeFormatter', $this);
        if ('Neos\Flow\I18n\Formatter\DatetimeFormatter' === get_class($this)) {
  ...
  'datesReader' => 'Neos\\Flow\\I18n\\Cldr\\Reader\\DatesReader',
    ...
    {
        $this->injectDatesReader(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\I18n\Cldr\Reader\DatesReader'));
        $this->Flow_Injected_Properties = array (
  0 => 'datesReader',
);
    }
}
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Formatter/DatetimeFormatter.php
#