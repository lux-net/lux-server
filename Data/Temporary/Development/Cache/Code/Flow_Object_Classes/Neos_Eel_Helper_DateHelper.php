 ...
 * Date helpers for Eel contexts
 */
class DateHelper extends DateHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Eel\Helper\DateHelper' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Eel/Classes/Helper/DateHelper.php
#