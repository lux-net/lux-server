...
class KickstartCommandController extends KickstartCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        parent::__construct();
        if ('Neos\Kickstarter\Command\KickstartCommandController' === get_class($this)) {
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->generatorService = new \Neos\Kickstarter\Service\GeneratorService();
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Kickstarter/Classes/Command/KickstartCommandController.php
#