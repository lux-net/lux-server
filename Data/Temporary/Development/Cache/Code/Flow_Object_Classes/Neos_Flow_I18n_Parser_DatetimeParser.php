 ...
 */
class DatetimeParser extends DatetimeParser_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Parser\DatetimeParser') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Parser\DatetimeParser', $this);
        if ('Neos\Flow\I18n\Parser\DatetimeParser' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Parser/DatetimeParser.php
#