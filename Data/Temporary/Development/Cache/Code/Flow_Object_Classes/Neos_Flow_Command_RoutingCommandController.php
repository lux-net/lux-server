 ...
 */
class RoutingCommandController extends RoutingCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Command\RoutingCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Command\RoutingCommandController', $this);
        parent::__construct();
        if ('Neos\Flow\Command\RoutingCommandController' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Command/RoutingCommandController.php
#