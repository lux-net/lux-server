 ...
 */
class ResourceCommandController extends ResourceCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Command\ResourceCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Command\ResourceCommandController', $this);
        parent::__construct();
        if ('Neos\Flow\Command\ResourceCommandController' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Command/ResourceCommandController.php
#