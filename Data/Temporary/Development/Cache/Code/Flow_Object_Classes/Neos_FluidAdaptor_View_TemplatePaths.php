 ...
 */
class TemplatePaths_Original extends \TYPO3Fluid\Fluid\View\TemplatePaths
{
    /**
     * @var string
     */
 ...
 * configuration when given a package name, and is aware of the Frontend/Backend contexts of TYPO3.
 */
class TemplatePaths extends TemplatePaths_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\FluidAdaptor\View\TemplatePaths' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.FluidAdaptor/Classes/View/TemplatePaths.php
#