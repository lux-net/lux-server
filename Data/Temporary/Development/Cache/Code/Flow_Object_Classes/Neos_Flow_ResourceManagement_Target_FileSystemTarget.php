 ...
 * A target which publishes resources to a specific directory in a file system.
 */
class FileSystemTarget extends FileSystemTarget_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Flow\ResourceManagement\Target\FileSystemTarget' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\ResourceManagement\Target\FileSystemTarget';
        if ($isSameClass) {
  ...
  'messageCollector' => 'Neos\\Flow\\ResourceManagement\\Publishing\\MessageCollector',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\Target\FileSystemTarget', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/ResourceManagement/Target/FileSystemTarget.php
#