 ...
 *       objectType: 'Some\Package\Domain\Model\Xyz'
 */
class IdentityRoutePart extends IdentityRoutePart_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Flow\Mvc\Routing\IdentityRoutePart' === get_class($this)) {
  ...
  'objectPathMappingRepository' => 'Neos\\Flow\\Mvc\\Routing\\ObjectPathMappingRepository',
  'objectType' => 'string',
  'uriPattern' => 'string',
  'splitString' => 'string',
  ...
  'options' => 'array',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\Flow\Mvc\Routing\ObjectPathMappingRepository', 'Neos\Flow\Mvc\Routing\ObjectPathMappingRepository', 'objectPathMappingRepository', '136158a68b0402f539d4baac169bb9ca', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Mvc\Routing\ObjectPathMappingRepository'); });
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Mvc/Routing/IdentityRoutePart.php
#