 ...
 */
class ValidatorResolver extends ValidatorResolver_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Validation\ValidatorResolver') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Validation\ValidatorResolver', $this);
        if ('Neos\Flow\Validation\ValidatorResolver' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Validation/ValidatorResolver.php
#