...
class GeneratorService extends GeneratorService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Kickstarter\Service\GeneratorService' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Kickstarter/Classes/Service/GeneratorService.php
#