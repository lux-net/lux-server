 ...
 */
class EntityManagerConfiguration_Original
{
    /**
     * @Flow\Inject
 ...
 */
class EntityManagerConfiguration extends EntityManagerConfiguration_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Persistence\Doctrine\EntityManagerConfiguration') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Persistence\Doctrine\EntityManagerConfiguration', $this);
        if ('Neos\Flow\Persistence\Doctrine\EntityManagerConfiguration' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Persistence/Doctrine/EntityManagerConfiguration.php
#