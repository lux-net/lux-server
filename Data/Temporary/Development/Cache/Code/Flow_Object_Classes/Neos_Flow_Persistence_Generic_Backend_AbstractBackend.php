 ...
 * @api
 */
abstract class AbstractBackend_Original implements BackendInterface
{
    /**
 ...
 * An abstract storage backend for the Flow persistence
 */
abstract class AbstractBackend extends AbstractBackend_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    protected function emitRemovedObject($object)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitRemovedObject'])) {
            $result = parent::emitRemovedObject($object);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitRemovedObject'] = TRUE;
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitRemovedObject', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRemovedObject']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRemovedObject']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitRemovedObject', $methodArguments, NULL, $result);
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitRemovedObject']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitRemovedObject']);
        }
    ...
    protected function emitPersistedObject($object, $objectState)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitPersistedObject'])) {
            $result = parent::emitPersistedObject($object, $objectState);

        } else {
            $this->Flow_Aop_Proxy_methodIsInAdviceMode['emitPersistedObject'] = TRUE;
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitPersistedObject', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitPersistedObject']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitPersistedObject']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Flow\Persistence\Generic\Backend\AbstractBackend', 'emitPersistedObject', $methodArguments, NULL, $result);
                    foreach ($advices as $advice) {
                        $advice->invoke($joinPoint);
                    }
                ...
                unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitPersistedObject']);
                throw $exception;
            }
            unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitPersistedObject']);
        }
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Persistence/Generic/Backend/AbstractBackend.php
#