 ...
 * @api
 */
class SelectViewHelper_Original extends AbstractFormFieldViewHelper
{
    /**
     * @Flow\Inject
     * @var Translator
 ...
 * </output>
 */
class SelectViewHelper extends SelectViewHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        parent::__construct();
        if ('Neos\FluidAdaptor\ViewHelpers\Form\SelectViewHelper' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.FluidAdaptor/Classes/ViewHelpers/Form/SelectViewHelper.php
#