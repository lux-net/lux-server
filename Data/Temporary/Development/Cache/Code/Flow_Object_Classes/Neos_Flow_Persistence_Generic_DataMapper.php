 ...
 */
class DataMapper extends DataMapper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Persistence\Generic\DataMapper') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Persistence\Generic\DataMapper', $this);
        if ('Neos\Flow\Persistence\Generic\DataMapper' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Persistence/Generic/DataMapper.php
#