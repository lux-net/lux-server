 ...
 * @\Neos\Flow\Annotations\Scope("singleton")
 */
class CommandController extends CommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        if (get_class($this) === 'Neos\Flow\Cli\CommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Cli\CommandController', $this);
        parent::__construct();
        if ('Neos\Flow\Cli\CommandController' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Cli/CommandController.php
#