 ...
 * @api
 */
class JsonView_Original extends AbstractView
{
    /**
     * Supported options
     * @var array
 ...
 * A JSON view
 */
class JsonView extends JsonView_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Flow\Mvc\View\JsonView' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Mvc/View/JsonView.php
#