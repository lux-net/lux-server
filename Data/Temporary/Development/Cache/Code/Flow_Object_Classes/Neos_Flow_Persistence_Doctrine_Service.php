...
class Service extends Service_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Persistence\Doctrine\Service') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Persistence\Doctrine\Service', $this);
        if ('Neos\Flow\Persistence\Doctrine\Service' === get_class($this)) {
  ...
  'environment' => '\\Neos\\Flow\\Utility\\Environment',
    ...
    {
        $this->entityManager = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Doctrine\Common\Persistence\ObjectManager');
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Persistence/Doctrine/Service.php
#