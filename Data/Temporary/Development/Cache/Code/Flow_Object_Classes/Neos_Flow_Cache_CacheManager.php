 ...
 */
class CacheManager extends CacheManager_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Cache\CacheManager') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Cache\CacheManager', $this);
        if ('Neos\Flow\Cache\CacheManager' === get_class($this)) {
  ...
  'cacheFactory' => 'Neos\\Flow\\Cache\\CacheFactory',
  ...
  'cacheConfigurations' => 'array',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->injectCacheFactory(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheFactory'));
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Cache/CacheManager.php
#