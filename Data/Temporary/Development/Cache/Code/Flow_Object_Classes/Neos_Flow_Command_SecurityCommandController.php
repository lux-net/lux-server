 ...
 */
class SecurityCommandController extends SecurityCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Command\SecurityCommandController') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Command\SecurityCommandController', $this);
        parent::__construct();
        if ('Neos\Flow\Command\SecurityCommandController' === get_class($this)) {
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->Flow_Proxy_LazyPropertyInjection('Neos\Flow\Security\Cryptography\RsaWalletServicePhp', 'Neos\Flow\Security\Cryptography\RsaWalletServicePhp', 'rsaWalletService', 'af297b869b8bc014359a01d28863b53c', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Security\Cryptography\RsaWalletServicePhp'); });
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Command/SecurityCommandController.php
#