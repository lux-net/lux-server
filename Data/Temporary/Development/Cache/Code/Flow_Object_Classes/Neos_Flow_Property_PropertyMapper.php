 ...
 */
class PropertyMapper extends PropertyMapper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Property\PropertyMapper') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Property\PropertyMapper', $this);
        if ('Neos\Flow\Property\PropertyMapper' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\Property\PropertyMapper';
        if ($isSameClass) {
  ...
  'messages' => 'Neos\\Error\\Messages\\Result',
);
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Property\PropertyMapper', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'cache', '408c7adde05f84da5019a099ffbc4093', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Flow_PropertyMapper'); });
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Property/PropertyMapper.php
#