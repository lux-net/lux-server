...
class Session extends Session_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        if (get_class($this) === 'Neos\Flow\Persistence\Generic\Session') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Persistence\Generic\Session', $this);
        parent::__construct();
        if ('Neos\Flow\Persistence\Generic\Session' === get_class($this)) {
  ...
  'reconstitutedEntities' => '\\SplObjectStorage',
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Persistence/Generic/Session.php
#