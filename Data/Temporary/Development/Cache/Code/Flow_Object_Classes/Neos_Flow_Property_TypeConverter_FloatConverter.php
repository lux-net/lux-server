 ...
 */
class FloatConverter extends FloatConverter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Property\TypeConverter\FloatConverter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Property\TypeConverter\FloatConverter', $this);
        if ('Neos\Flow\Property\TypeConverter\FloatConverter' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Property/TypeConverter/FloatConverter.php
#