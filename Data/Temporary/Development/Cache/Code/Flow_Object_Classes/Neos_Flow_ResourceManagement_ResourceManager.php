 ...
 */
class ResourceManager extends ResourceManager_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\ResourceManagement\ResourceManager') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\ResourceManagement\ResourceManager', $this);
        if ('Neos\Flow\ResourceManagement\ResourceManager' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\ResourceManagement\ResourceManager';
        if ($isSameClass) {
  ...
  'storages' => 'array<Neos\\Flow\\ResourceManagement\\Storage\\StorageInterface>',
  'targets' => 'array<Neos\\Flow\\ResourceManagement\\Target\\TargetInterface>',
  'collections' => 'array<Neos\\Flow\\ResourceManagement\\CollectionInterface>',
  'initialized' => 'boolean',
);
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\ResourceManager', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/ResourceManagement/ResourceManager.php
#