 ...
 * Represents an internal request targeted to a controller action
 */
class ActionRequest extends ActionRequest_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {

    use \Neos\Flow\Aop\AdvicesTrait, \Neos\Flow\ObjectManagement\DependencyInjection\PropertyInjectionTrait;
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(0, $arguments)) throw new \Neos\Flow\ObjectManagement\Exception\UnresolvedDependenciesException('Missing required constructor argument $parentRequest in class ' . __CLASS__ . '. Note that constructor injection is only support for objects of scope singleton (and this is not a singleton) – for other scopes you must pass each required argument to the constructor yourself.', 1296143788);
        call_user_func_array('parent::__construct', $arguments);
        if ('Neos\Flow\Mvc\ActionRequest' === get_class($this)) {
    ...
    protected function emitRequestDispatched($request)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitRequestDispatched'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Flow\Mvc\ActionRequest', 'emitRequestDispatched', $methodArguments);
                $result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
                $methodArguments = $joinPoint->getMethodArguments();

                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRequestDispatched']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    $advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitRequestDispatched']['Neos\Flow\Aop\Advice\AfterReturningAdvice'];
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Flow\Mvc\ActionRequest', 'emitRequestDispatched', $methodArguments, NULL, $result);
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Mvc/ActionRequest.php
#