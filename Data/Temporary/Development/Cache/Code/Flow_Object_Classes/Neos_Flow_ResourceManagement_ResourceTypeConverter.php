 ...
 */
class ResourceTypeConverter extends ResourceTypeConverter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\ResourceManagement\ResourceTypeConverter') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\ResourceManagement\ResourceTypeConverter', $this);
        if ('Neos\Flow\ResourceManagement\ResourceTypeConverter' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/ResourceManagement/ResourceTypeConverter.php
#