...
class MethodPrivilegePointcutFilter extends MethodPrivilegePointcutFilter_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Security\Authorization\Privilege\Method\MethodPrivilegePointcutFilter', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
  ...
  'filters' => 'PointcutFilterComposite[]',
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Security/Authorization/Privilege/Method/MethodPrivilegePointcutFilter.php
#