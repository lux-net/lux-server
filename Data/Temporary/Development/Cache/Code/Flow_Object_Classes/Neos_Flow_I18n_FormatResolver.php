 ...
 */
class FormatResolver extends FormatResolver_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\FormatResolver') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\FormatResolver', $this);
        if ('Neos\Flow\I18n\FormatResolver' === get_class($this)) {
  ...
  'formatters' => 'array<Neos\\Flow\\I18n\\Formatter\\FormatterInterface>',
);
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/FormatResolver.php
#