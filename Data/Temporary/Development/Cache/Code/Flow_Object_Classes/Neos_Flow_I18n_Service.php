 ...
 */
class Service extends Service_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Service') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Service', $this);
        if ('Neos\Flow\I18n\Service' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\I18n\Service';
        if ($isSameClass) {
  ...
  'configuration' => 'Neos\\Flow\\I18n\\Configuration',
  'localeBasePath' => 'string',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Service', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('', '', 'cache', '2c9e8a97c89088b678d984dc46644859', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Cache\CacheManager')->getCache('Flow_I18n_AvailableLocalesCache'); });
        ...
        $this->localeCollection = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\I18n\LocaleCollection');
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Service.php
#