 ...
 */
class RsaWalletServicePhp_Original implements RsaWalletServiceInterface
{
    /**
     * @var string
     */
 ...
 */
class RsaWalletServicePhp extends RsaWalletServicePhp_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Security\Cryptography\RsaWalletServicePhp') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Security\Cryptography\RsaWalletServicePhp', $this);
        if (get_class($this) === 'Neos\Flow\Security\Cryptography\RsaWalletServicePhp') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Security\Cryptography\RsaWalletServiceInterface', $this);
        if ('Neos\Flow\Security\Cryptography\RsaWalletServicePhp' === get_class($this)) {
            $this->Flow_Proxy_injectProperties();
        }

        $isSameClass = get_class($this) === 'Neos\Flow\Security\Cryptography\RsaWalletServicePhp';
        if ($isSameClass) {
  ...
  'saveKeysOnShutdown' => 'boolean',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Security\Cryptography\RsaWalletServicePhp', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Security/Cryptography/RsaWalletServicePhp.php
#