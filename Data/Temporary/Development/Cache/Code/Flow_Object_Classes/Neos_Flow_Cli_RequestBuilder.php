 ...
 */
class RequestBuilder extends RequestBuilder_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\Cli\RequestBuilder') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\Cli\RequestBuilder', $this);
        if ('Neos\Flow\Cli\RequestBuilder' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Cli/RequestBuilder.php
#