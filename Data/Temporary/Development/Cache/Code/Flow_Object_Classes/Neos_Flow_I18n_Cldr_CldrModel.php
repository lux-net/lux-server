...
class CldrModel extends CldrModel_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'parsedData' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Cldr\CldrModel', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/CldrModel.php
#