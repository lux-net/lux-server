 ...
 */
class CldrParser_Original extends AbstractXmlParser
{
    /**
 ...
 */
class CldrParser extends CldrParser_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Cldr\CldrParser') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Cldr\CldrParser', $this);
    }
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/CldrParser.php
#