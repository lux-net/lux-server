...
latex_documents = [
  (master_doc, 'AgzHack.Api.tex', u'AgzHack.Api Documentation',
   u'The author', 'manual'),
]
...
man_pages = [
    (master_doc, 'AgzHack.Api', u'AgzHack.Api Documentation',
     [author], 1)
]
