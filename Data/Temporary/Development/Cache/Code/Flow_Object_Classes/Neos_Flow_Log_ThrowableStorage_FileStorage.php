 ...
 */
class FileStorage_Original implements ThrowableStorageInterface
{
    /**
     * @var string
     */
 ...
 * Stores detailed information about throwables into files.
 */
class FileStorage extends FileStorage_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Flow\Log\ThrowableStorage\FileStorage' === get_class($this)) {
  ...
  'storagePath' => 'string',
  'requestInformationRenderer' => '\\Closure',
  'backtraceRenderer' => '\\Closure',
);
    ...
    {
        $this->injectStoragePath(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Flow.log.throwables.fileStorage.path'));
        $this->Flow_Injected_Properties = array (
  0 => 'storagePath',
);
    }
}
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/Log/ThrowableStorage/FileStorage.php
#