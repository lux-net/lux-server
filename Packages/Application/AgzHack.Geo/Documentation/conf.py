...
latex_documents = [
  (master_doc, 'AgzHack.Geo.tex', u'AgzHack.Geo Documentation',
   u'The author', 'manual'),
]
...
man_pages = [
    (master_doc, 'AgzHack.Geo', u'AgzHack.Geo Documentation',
     [author], 1)
]
