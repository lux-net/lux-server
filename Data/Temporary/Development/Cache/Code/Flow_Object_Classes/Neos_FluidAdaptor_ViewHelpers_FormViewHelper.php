 ...
 * @api
 */
class FormViewHelper_Original extends AbstractFormViewHelper
{
    /**
     * @var string
     */
...
class FormViewHelper extends FormViewHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        parent::__construct();
        if ('Neos\FluidAdaptor\ViewHelpers\FormViewHelper' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.FluidAdaptor/Classes/ViewHelpers/FormViewHelper.php
#