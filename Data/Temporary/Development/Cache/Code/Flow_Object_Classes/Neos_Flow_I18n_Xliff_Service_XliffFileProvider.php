...
class XliffFileProvider extends XliffFileProvider_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'files' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Xliff\Service\XliffFileProvider', $classParents) !== FALSE && array_search('Doctrine\ORM\Proxy\Proxy', $classImplements) !== FALSE;
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Xliff/Service/XliffFileProvider.php
#