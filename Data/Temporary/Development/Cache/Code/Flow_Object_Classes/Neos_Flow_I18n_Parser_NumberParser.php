 ...
 */
class NumberParser extends NumberParser_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\Flow\I18n\Parser\NumberParser') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\Flow\I18n\Parser\NumberParser', $this);
        if ('Neos\Flow\I18n\Parser\NumberParser' === get_class($this)) {
...
# PathAndFilename: /var/www/lux/Packages/Framework/Neos.Flow/Classes/I18n/Parser/NumberParser.php
#